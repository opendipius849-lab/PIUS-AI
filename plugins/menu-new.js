...
> *© 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚀𝙰𝙳𝙴𝙴𝚁 𝙰𝙸 🤖* `;
        ...
        const sendInitialImage = async () => {
            try {
                ...
                }, { quoted: verifiedReply }); // Change here: Quoted with verifiedReply
            } catch (e) {
                console.log('Image send failed, falling back to text');
                return await client.sendMessage(from, { text: initialMenuText, contextInfo: contextInfo }, { quoted: verifiedReply }); // Change here: Quoted with verifiedReply
            }
        };
        ...
        try {
            ...
            if (!menuMessage) {
                menuMessage = await client.sendMessage(from, { text: initialMenuText, contextInfo: contextInfo }, { quoted: verifiedReply }); // Change here: Quoted with verifiedReply
            }
        }
            ...
            try {
                ...
                if (isReplyToMenu) {
                    ...
                    if (menuOptions[userResponse]) {
                        ...
                        await client.sendMessage(remoteJid, {
                            text: '❌ *Invalid Option!* ❌\n\nPlease reply with a number between 1-13 to select a menu.\n\n*Example:* Reply with "1" for Download Menu\n\n> *© 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚀𝙰𝙳𝙴𝙴𝚁 𝙰𝙸 🤖* ',
                            contextInfo: contextInfo
                        }, { quoted: incomingMessage });
                    }
                }
