...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: 3dcomic Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: neonlight Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: cat Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: sadgirl Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: pornhub Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: naruto Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: thor Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: America Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: Eraser Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: 3dpaper Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: futuristic Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: Clouds Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: sand Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: galaxy Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: leaf Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: sunset Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: devilwings Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: hacker Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: boom Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: luxury Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: Zodiac Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: angelwings Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: bulb Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: Tatoo Qadeer");
        }
        
        const name = args.join(" ");
        
        // API URL with user-provided name
        const apiUrl = `https://api-pink-venom.vercel.app/api/logo?url=https://en.ephoto360.com/make-tattoos-online-by-Qadeer-tech-309.html&name=${encodeURIComponent(name)}`;
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: castle Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: frozen Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: paint Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: birthday Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: Typography Qadeer");
        }
...
cmd({
    ...
    try {
        if (!args.length) {
            return reply("❌ Please provide a name. Example: bear Qadeer");
        }
