...
//===================SESSION-AUTH============================
// --- THIS IS THE NEW SESSION CODE YOU REQUESTED ---
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    if (!config.SESSION_ID) {
        return console.log('Please add your session to SESSION_ID env !!');
    }
    // Note: You might want to use a unique prefix for your session ID
...
const port = process.env.PORT || 9090;
  ...
  const conn = makeWASocket({
          ...
          printQRInTerminal: false, // Changed to false as session is from ID
...
const qadeer = ['923151105391','923079749129'] 
const dev = [] 
